> [!WARNING]
> All new code in this fork was generated by an LLM.
...
#### add_md_file / rm_md_file
Programmatically add or remove markdown files (like `AGENT.md`) to be used as context.
...
Referenced content is automatically resolved and injected into the AI context. Native completions work by default. For nvim-cmp set `source = "cmp"`. For blink.cmp, set `source = "blink"` (requires [blink.compat](https://github.com/saghen/blink.compat)).
