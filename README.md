...
| `implement` | `fun(opts?: _99.ops.Opts): _99.TraceID` | - |
| `output` | `fun(): nil` | - |
| `view_logs` | `fun(): nil` | - |
| `info` | `fun(): nil` | - |
| `stop_all_requests` | `fun(): nil` | - |
| `clear_previous_requests` | `fun(): nil` | - |
| `add_md_file` | `fun(md: string): _99` | - |
| `rm_md_file` | `fun(md: string): _99` | - |
| `set_model` | `fun(model: string): _99` | - |
| `get_model` | `fun(): string` | - |
| `set_provider` | `fun(provider: _99.Providers.BaseProvider): _99` | - |
| `get_provider` | `fun(): _99.Providers.BaseProvider` | - |
...
#### provider_extra_args
Additional arguments for the provider's CLI.
...
#### auto_open_output
Automatically open the output window when a request starts.
